...
const (
	Query_Params_FullMethodName   = "/realfin.oracle.Query/Params"
	Query_Price_FullMethodName    = "/realfin.oracle.Query/Price"
	Query_PriceAll_FullMethodName = "/realfin.oracle.Query/PriceAll"
)
