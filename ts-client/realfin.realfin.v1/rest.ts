...
import { QueryParamsResponse } from "./types/realfin/realfin/v1/query";

import { QueryParamsRequest } from "./types/realfin/realfin/v1/query";
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @tags Query
   * @name queryParams
   * @request GET:/realfin/realfin/v1/params
   */
  queryParams = (
    ...
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryParamsResponse>>>({
      path: `/realfin/realfin/v1/params`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
