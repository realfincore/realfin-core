...
import { QueryParamsResponse } from "./types/realfin/oracle/v1/query";
import { QueryGetPriceResponse } from "./types/realfin/oracle/v1/query";
import { QueryAllPriceResponse } from "./types/realfin/oracle/v1/query";

import { QueryParamsRequest } from "./types/realfin/oracle/v1/query";
import { QueryGetPriceRequest } from "./types/realfin/oracle/v1/query";
import { QueryAllPriceRequest } from "./types/realfin/oracle/v1/query";
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @tags Query
   * @name queryParams
   * @request GET:/realfin/oracle/v1/params
   */
  queryParams = (
   ...
   * @tags Query
   * @name queryGetPrice
   * @request GET:/realfin/oracle/v1/price/{symbol}
   */
  queryGetPrice = (symbol: string,
    query?: Record<string, any>,
    params: RequestParams = {},
  ) =>
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryGetPriceResponse>>>({
      path: `/realfin/oracle/v1/price/${symbol}`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @tags Query
   * @name queryListPrice
   * @request GET:/realfin/oracle/v1/price
   */
  queryListPrice = (
    query?: Omit<FlattenObject<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryAllPriceRequest>>>,"">,
    params: RequestParams = {},
  ) =>
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryAllPriceResponse>>>({
      path: `/realfin/oracle/v1/price`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
