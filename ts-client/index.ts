...
import { IgntModule as RealfinCreditscoreV_1, msgTypes as RealfinCreditscoreV_1MsgTypes } from './realfin.creditscore.v1'
import { IgntModule as RealfinOracleV_1, msgTypes as RealfinOracleV_1MsgTypes } from './realfin.oracle.v1'
import { IgntModule as RealfinRealestateV_1, msgTypes as RealfinRealestateV_1MsgTypes } from './realfin.realestate.v1'
import { IgntModule as RealfinRealfinV_1, msgTypes as RealfinRealfinV_1MsgTypes } from './realfin.realfin.v1'
...
const Client = IgniteClient.plugin([
    RealfinCreditscoreV_1, RealfinOracleV_1, RealfinRealestateV_1, RealfinRealfinV_1, CosmosNftV_1Beta_1, CosmosAuthV_1Beta_1, CosmosAuthzV_1Beta_1, CosmosBankV_1Beta_1, CosmosBaseNodeV_1Beta_1, CosmosBaseTendermintV_1Beta_1, CosmosConsensusV_1, CosmosDistributionV_1Beta_1, CosmosEpochsV_1Beta_1, CosmosGovV_1, CosmosGovV_1Beta_1, CosmosGroupV_1, CosmosMintV_1Beta_1, CosmosParamsV_1Beta_1, CosmosSlashingV_1Beta_1, CosmosStakingV_1Beta_1, CosmosTxV_1Beta_1, CosmosVestingV_1Beta_1, CosmosUpgradeV_1Beta_1, CosmosCircuitV_1, IbcApplicationsInterchainAccountsControllerV_1, IbcApplicationsInterchainAccountsHostV_1, IbcApplicationsTransferV_1, IbcCoreChannelV_1, IbcCoreChannelV_2, IbcCoreClientV_1, IbcCoreClientV_2, IbcCoreConnectionV_1, CosmosEvidenceV_1Beta_1, CosmosFeegrantV_1Beta_1
]);

const registry = new Registry([
  ...RealfinCreditscoreV_1MsgTypes,
  ...RealfinOracleV_1MsgTypes,
  ...RealfinRealestateV_1MsgTypes,
  ...RealfinRealfinV_1MsgTypes,
