...
import { QueryParamsResponse } from "./types/realfin/creditscore/v1/query";
import { QueryGetRateResponse } from "./types/realfin/creditscore/v1/query";
import { QueryAllRateResponse } from "./types/realfin/creditscore/v1/query";

import { QueryParamsRequest } from "./types/realfin/creditscore/v1/query";
import { QueryGetRateRequest } from "./types/realfin/creditscore/v1/query";
import { QueryAllRateRequest } from "./types/realfin/creditscore/v1/query";
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @tags Query
   * @name queryParams
   * @request GET:/realfin/creditscore/v1/params
   */
  queryParams = (
    ...
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryParamsResponse>>>({
      path: `/realfin/creditscore/v1/params`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @tags Query
   * @name queryGetRate
   * @request GET:/realfin/creditscore/v1/rate/{symbol}
   */
  queryGetRate = (symbol: string,
    query?: Record<string, any>,
    params: RequestParams = {},
  ) =>
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryGetRateResponse>>>({
      path: `/realfin/creditscore/v1/rate/${symbol}`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @tags Query
   * @name queryListRate
   * @request GET:/realfin/creditscore/v1/rate
   */
  queryListRate = (
    query?: Omit<FlattenObject<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryAllRateRequest>>>,"">,
    params: RequestParams = {},
  ) =>
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryAllRateResponse>>>({
      path: `/realfin/creditscore/v1/rate`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
