...
import { QueryParamsResponse } from "./types/realfin/realestate/v1/query";
import { QueryGetRateResponse } from "./types/realfin/realestate/v1/query";
import { QueryAllRateResponse } from "./types/realfin/realestate/v1/query";

import { QueryParamsRequest } from "./types/realfin/realestate/v1/query";
import { QueryGetRateRequest } from "./types/realfin/realestate/v1/query";
import { QueryAllRateRequest } from "./types/realfin/realestate/v1/query";
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @tags Query
   * @name queryParams
   * @request GET:/realfin/realestate/v1/params
   */
  queryParams = (
    ...
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryParamsResponse>>>({
      path: `/realfin/realestate/v1/params`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @tags Query
   * @name queryGetRate
   * @request GET:/realfin/realestate/v1/rate/{symbol}
   */
  queryGetRate = (symbol: string,
    ...
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryGetRateResponse>>>({
      path: `/realfin/realestate/v1/rate/${symbol}`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @tags Query
   * @name queryListRate
   * @request GET:/realfin/realestate/v1/rate
   */
  queryListRate = (
    ...
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryAllRateResponse>>>({
      path: `/realfin/realestate/v1/rate`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
